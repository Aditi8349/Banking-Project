    ...
    <body>
        <%
         try
         {
             ...
             String updatepasswordQuery1 ="Update account set cusname='"+ cname+"'where accno='"+ acno +"'";
             PreparedStatement pst1 = con.prepareStatement( updatepasswordQuery1 );
             pst1.executeUpdate();  
               
             String updatepasswordQuery2 ="Update account set cusfname='"+ cfname+"'where accno='"+acno +"'";
             PreparedStatement pst2 = con.prepareStatement( updatepasswordQuery2 );
             pst2.executeUpdate();
             
              String updatepasswordQuery3 ="Update account set dob='"+ cdob +"'where accno='"+acno +"'";
             PreparedStatement pst3 = con.prepareStatement( updatepasswordQuery3 );
             pst1.executeUpdate();
             
              String updatepasswordQuery4 ="Update account set gender='"+ cgender+"'where accno='"+acno +"'";
             PreparedStatement pst4 = con.prepareStatement( updatepasswordQuery4 );
             pst4.executeUpdate();
             
              
             
              String updatepasswordQuery6 ="Update account set address='"+ cadd+"'where accno='"+acno +"'";
             PreparedStatement pst6 = con.prepareStatement( updatepasswordQuery6 );
             pst6.executeUpdate();
             
              String updatepasswordQuery7 ="Update account set contactno='"+ ccontact+"'where accno='"+acno +"'";
             PreparedStatement pst7 = con.prepareStatement( updatepasswordQuery7 );
             pst7.executeUpdate();
             
              String updatepasswordQuery8 ="Update account set password='"+ pass+"'where accno='"+acno +"'";
             PreparedStatement pst8= con.prepareStatement( updatepasswordQuery8 );
             pst8.executeUpdate();
             
              String updatepasswordQuery9 ="Update account set sques='"+ sques+"'where accno='"+acno +"'";
             PreparedStatement pst9 = con.prepareStatement( updatepasswordQuery9 );
             pst9.executeUpdate();
             
              String updatepasswordQuery5 ="Update account set sans='"+ sans+"'where accno='"+acno +"'";
